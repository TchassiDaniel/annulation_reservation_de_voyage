    ...
    return (
        <div className="min-h-screen p-4">
            ...
            <div className="flex gap-5 mt-4">
                <div className="relative h-[520px] w-[65.666%] rounded-lg overflow-hidden ">
                    <div
                        ...
                        <div className="max-w-7xl mx-auto">
                            ...
                            <button onClick={() => {
                                setCanOpenReservationModal(true)
                                    ...
                                    className="absolute bottom-8 right-8 bg-reservation-color text-white px-5 py-2.5 text-2xl hover:bg-white hover:text-reservation-color hover:border-4 hover:border-reservation-color rounded-lg font-bold shadow-lg transition-all duration-300 flex items-center gap-2 ">
                                <span>Book Now</span>
                            </button>
                        </div>
                    </div>
            ...
            <div className="mx-auto mt-4 mb-4">
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-gray-100 rounded-xl shadow-sm p-6">
                            ...
                            <div className="flex gap-3 mb-2">
                                ...
                                <h3 className="font-bold text-xl mb-3 text-reservation-color">Equipment and services on
                                    the bus</h3>
                            </div>
                    ...
                    <div className="bg-gray-100 rounded-xl shadow-sm p-4 space-y-1">
                        <div className="flex gap-3">
            ...
            <ReservationProcessModal isOpen={canOpenReservationModal} onClose={() => {
