            ...
            <div className="bg-white rounded-xl w-full max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-start mb-6">
                    <div className="flex gap-2 ml-16">
                        ...
                        <h2 className="text-3xl font-bold text-reservation-color mt-1">Trip Details</h2>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                            <p className="text-2xl font-bold text-reservation-color">{trip.price.toLocaleString()} FCFA</p>
                            <div className="flex gap-1 ml-7">
                                <MdAirlineSeatReclineNormal className="text-green-500 w-6 h-6"/>
                                <p className="text-sm  text-green-500 font-semibold mt-1">Seat {trip.seatNumber}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="border-t border-gray-400 pt-4">
                        <div className="flex gap-1 mb-2">
                            ...
                            <h4 className="text-xl text-reservation-color font-bold ">Additional information</h4>
                        </div>
                        <ul className="ml-10 space-y-2 pb-4 text-gray-600">
                            <li className="flex gap-3"><p>Transport company :</p> <p className="font-semibold">{trip.company}</p></li>
                            <li className="flex gap-3"><p>Type of bus:</p><p className="font-semibold">{trip.busType}</p></li>
                            <li className="flex gap-3"><p>Seat number:</p> <p className="font-semibold">{trip.seatNumber}</p></li>
                            <li className="flex gap-3"><p>Estimated travel time:</p><p className="font-semibold">4 hours</p> </li>
                        </ul>
                    </div>
                    ...
                    <div className="border-t border-gray-200 pt-6 mb-5">
                        ...
                        <p className="text-gray-600 ml-10">
                            Free cancellation up to 24 hours before departure. Fees may apply for
                            late cancellations. Please see our terms and conditions for further details.
                        </p>
                    </div>
