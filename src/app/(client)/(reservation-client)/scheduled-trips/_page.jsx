    ...
    <div className="min-h-screen p-4">
      ...
      <div className="mx-auto py-6">
        ...
        <div className="space-y-4">
          {trips
            .filter((trip) => activeTab === "all" || trip.status === activeTab)
            .map((trip) => (
              <div
                key={trip.id}
                  ...
                  <div className="flex gap-[248px]">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{trip.arrivalLocation}</p>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-orange-600">
                              on a total of {trip.totalAmount.toLocaleString()}{" "}
                              FCFA
                            </p>
                          </div>
                        </div>
      ...
      <div className=" w-full justify-center flex mt-6 mb-4">
        <div className="flex gap-4">
          ...
          <p className="text-reservation-color text-2xl font-bold mt-4">
            {"1/10"}
          </p>
      ...
      <TripDetailsModal
        trip={selectedTrip}
        isOPen={canOpenTripDetailModal}
        onClose={() => setCanOpenTripDetailModal(false)}
      />
      <TripAnnulationModal
        trip={selectedTrip}
