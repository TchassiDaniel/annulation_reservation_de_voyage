      ...
      <div className="p-2 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row bg-gray-100 items-center mb-8 p-4 sm:p-6 rounded-xl">
          <div className="flex items-center gap-4 mb-4 sm:mb-0">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-reservation-color">Reservation Details</h1>
              <p className="text-sm sm:text-base text-gray-500 font-medium mt-1">
                Booking Reference: {reservationDetails?.reservation?.idReservation}
              </p>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
            <div className="h-[500px] flex justify-center items-center">
              <div className="flex flex-col items-center">
                ...
                <p className="animate-bounce text-reservation-color text-xl font-bold mt-4">Loading...</p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md">
                <div className="p-4 sm:p-6">
                  <div className="flex justify-between mb-4 sm:mb-7">
                    <div className="flex items-center gap-2 mb-4 sm:mb-0">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-sm sm:text-md">{reservationDetails?.voyage?.titre} </p>
                      </div>
                    </div>
                    <div className="flex flex-wrap gap-2 sm:gap-4 items-center">
                      <span
                          className={`flex justify-center items-center px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium ${
                              reservationDetails?.reservation?.statutReservation === "CONFIRMER"
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-bold">{reservationDetails?.agence?.nom || "not specified"}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-bold">{Number.parseInt(reservationDetails?.reservation?.montantPaye)} FCFA</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                ...
                <div className="bg-orange-50 p-4">
                  ...
                  <p className="text-md ml-10 text-justify text-orange-800">
                    Cancellation policies vary by agency and take into account the time of year, ticket price and the time
                    between cancellation and travel date. Depending on these criteria, cancellation fees may apply, or a
                    coupon of varying value may be generated for future use.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8">
                <div className="p-4 sm:p-6">
                  <h2 className="text-xl lg:text-3xl font-semibold text-reservation-color mb-4 sm:mb-6">Passenger Details</h2>
                        ...
                        >
                          ...
                          <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm mb-4 sm:mb-6">
                            ...
                            <p className="flex items-center">
                              ...
                              {Number.parseInt(reservationDetails?.reservation?.prixTotal) /
                              Number.parseInt(reservationDetails?.reservation?.nbrPassager)}{" "}
                                FCFA
                        </span>
                            </p>
                          </div>
                          <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4">
                            ...
                            >
                              <Printer className="mr-1 sm:mr-2 h-4 w-4 sm:h-5 sm:w-5" /> Print Ticket
                            </button>
                            <button
                            ...
                            >
                              <MdCancel className="mr-1 sm:mr-2 h-4 w-4 sm:h-5 sm:w-5" /> Cancel Trip
                            </button>
                          </div>
                        </div>
                    ))}
