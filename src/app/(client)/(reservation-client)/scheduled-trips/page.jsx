        ...
        <div className="min-h-screen  ">
            <div className="bg-gray-100 rounded-lg mb-5">
                <div className="mx-auto px-4 py-6">
                    <h1 className="text-2xl sm:text-3xl font-bold text-reservation-color">My Booked Trips</h1>
                    ...
                    <>
                        {myScheduledTrips?.length > 0 &&
                                        ...
                                        <div className="p-4 sm:p-6">
                                            <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <h3 className="text-base sm:text-lg font-semibold">{tripDetails?.titre}</h3>
                                                </div>
                            ...
                            {"VIP"}
                                            ...
                                            <div className="ml-2 sm:ml-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                <div className="space-y-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div>
                                                            <p className="text-sm sm:text-md text-gray-500">Transport agency</p>
                                                            <p className="font-bold">
                                                                {tripDetails.nomAgence ? tripDetails?.nomAgence : "not specified"}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div>
                                                            <p className="text-sm sm:text-md text-gray-500">Departure Date</p>
                                                            <p className="font-bold">
                                                ...
                                                <div className="space-y-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div>
                                                            <p className="text-sm sm:text-md text-gray-500">Departure Time</p>
                                                            <p className="font-bold">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div>
                                                            <p className="text-sm sm:text-md text-gray-500">Reservation Date</p>
                                                            <p className="font-bold">
                                                                {reservation?.dateReservation
                                                                    ? formatFullDateTime(reservation?.dateReservation)
                                                                    : "not specified"}
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="space-y-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div>
                                                            <div className="flex gap-3">
                                                                <p className="text-sm sm:text-md text-gray-500">Passengers:</p>
                                                                <p className="font-bold">{reservation?.nbrPassager}</p>
                                                            </div>
                                                            <div className="flex gap-3">
                                                                <p className="text-sm sm:text-md text-gray-500">Seats: </p>
                                                                <p className="font-bold">
                                                                    {mockReservation.passengers.map((p) => p.seatNumber).join(", ")}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center gap-2">
                                                        <AlertCircle className="text-reservation-color h-5 w-5" />
                                                        <div>
                                                            <p className="text-sm sm:text-md text-gray-500">Payment Deadline</p>
                                                            <p className="font-bold">
                                                                {tripDetails?.dateLimiteConfirmation
                                                                    ? formatDateOnly(tripDetails?.dateLimiteConfirmation)
                                                                    : "not specified"}
                                                            </p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div
                                            className={`flex flex-col sm:flex-row ${reservation?.statutReservation === "RESERVER" ? "sm:justify-between" : "sm:justify-end"} items-center p-4 gap-4`}
                                        >
                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <p className="font-medium text-orange-800 text-sm sm:text-base">
                                                                    ...
                                                                    {Number.parseInt(reservation?.prixTotal) - Number.parseInt(reservation?.montantPaye)}
                                                                </p>
                                                                <p className="text-xs sm:text-sm text-orange-600">
                                                                    on a total of {Number.parseInt(reservation?.prixTotal)}FCFA
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <button
                                    ...
                                    {totalPages > 5 ? (
                                        <>
                                            <div className="flex items-center gap-1 sm:gap-2">
                                                ...
                                                <span className="flex items-center justify-center px-2 text-gray-500">...</span>
                                                <button className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-white text-reservation-color hover:bg-gray-50 font-medium flex items-center justify-center border-2 border-gray-200">
                                                    {totalPages}
                                                </button>
                                            </div>
