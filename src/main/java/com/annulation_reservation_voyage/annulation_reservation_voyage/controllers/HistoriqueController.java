...
public class HistoriqueController {
    ...
    @Operation(summary = "Obtenir tous les historiques",
            description = "Récupère la liste de tous les historiques.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Liste récupérée avec succès",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = Historique.class))))
    })
    @GetMapping
    ...
    @Operation(summary = "Obtenir un historique par ID",
            description = "Récupère un historique spécifique par ID.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Créer un historique",
            description = "Ajoute un nouvel historique.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Mettre à jour un historique",
            description = "Modifie un historique existant.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Supprimer un historique",
            description = "Supprime un historique par son ID.")
    @ApiResponses(value = {
