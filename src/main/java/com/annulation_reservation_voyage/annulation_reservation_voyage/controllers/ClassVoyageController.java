...
import com.annulation_reservation_voyage.annulation_reservation_voyage.services.ClassVoyageService;
...
public class ClassVoyageController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
                    ...
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = ClassVoyage.class))))
    })
    @GetMapping
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Classe de voyage trouvée",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ClassVoyage.class))),
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ClassVoyage> updateClassVoyage(@PathVariable UUID id, @RequestBody ClassVoyageDTO classVoyageDTO) {
