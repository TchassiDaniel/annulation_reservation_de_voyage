...
import com.annulation_reservation_voyage.annulation_reservation_voyage.services.BaggageService;
...
public class BaggageController {
    ...
    @Operation(summary = "Obtenir tous les bagages",
            description = "Récupère la liste de tous les bagages.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Liste récupérée avec succès",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = Baggage.class))))
    })
    @GetMapping
    ...
    @Operation(summary = "Obtenir un bagage par ID",
            description = "Récupère un bagage spécifique par son ID.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Bagage trouvé",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = Baggage.class))),
    ...
    @Operation(summary = "Créer un bagage",
            description = "Ajoute un nouveau bagage.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Bagage créé avec succès",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = Baggage.class))),
    ...
    @Operation(summary = "Mettre à jour un bagage",
            description = "Modifie un bagage existant.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Bagage mis à jour avec succès",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = Baggage.class))),
            @ApiResponse(responseCode = "404", description = "Bagage non trouvé"),
            @ApiResponse(responseCode = "400", description = "Données invalides")
    })
    ...
    @Operation(summary = "Supprimer un bagage",
            description = "Supprime un bagage par son ID.")
    @ApiResponses(value = {
