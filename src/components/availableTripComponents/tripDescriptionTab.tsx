        ...
        {activeTab === "description" && (
          <div
            ...
            <p className="text-gray-700 mb-4">
              Partez à la découverte de Bali, une île paradisiaque où nature
              luxuriante et culture ancestrale se rencontrent. Ce voyage vous
              permettra d&apos;explorer les plus beaux temples, de vous détendre
              sur des plages de sable fin, et de vous immerger dans la culture
              balinaise.
            </p>
            <p className="text-gray-700 mb-4">
              Vous séjournerez dans des hôtels soigneusement sélectionnés,
              alliant confort moderne et architecture traditionnelle. Notre
              guide local francophone vous accompagnera tout au long de votre
              séjour pour vous faire découvrir les trésors cachés de l&apos;île.
            </p>
          </div>
        )}
