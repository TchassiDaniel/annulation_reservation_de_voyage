...
import {FaBus, FaHistory, FaHome, FaSignOutAlt, FaTicketAlt} from "react-icons/fa";
...
export function Sidebar() {
  ...
  return (
      <div className="flex flex-col mt-4 mr-2 w-[210px] max-lg:w-full relative justify-between h-screen">
        <div className="flex flex-col">
          ...
          />
          <nav className="mt-3 ml-6 flex flex-col ">
                ...
                return (
                    <li
                        ...
                        className={`p-3 rounded-lg ${
                            isActive ? "bg-reservation-color text-white" : ""
                        }`}
                    >
                      <Link href={link.Link} className="flex gap-4 items-center">
                        {IconComponent && (
                            <IconComponent
                                className={`text-xl hover:bg-white/80 ${
        ...
        <button className="ml-6 flex mb-16 hover:bg-reservation-color hover:text-white p-4 rounded-xl text-black hover:font-bold transtion-all duration-300">
